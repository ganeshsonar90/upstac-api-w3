...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests() {
        ...
        if (testRequestQueryService == null)
            throw new AppException("Something went wrong");

        List<TestRequest> testRequestList = testRequestQueryService.findBy(RequestStatus.INITIATED);
        return testRequestList; // replace this line with your code
    ...
    public TestRequest updateLabTest(@PathVariable Long id, @RequestBody CreateLabResult createLabResult) {
        ...
        try {
            User user = userLoggedInService.getLoggedInUser();
            TestRequest updateLabTest = testRequestUpdateService.updateLabTest(id, createLabResult, user);

            return updateLabTest; // replace this line of code with your implementation
