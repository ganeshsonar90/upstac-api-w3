...
public class LabResultService {
    ...
    private LabResult createLabResult(User tester, TestRequest testRequest) {
        ...
        LabResult saveLabResult = saveLabResult(labResult);

        return saveLabResult; // replace this line with your code
    }
    ...
    public LabResult updateLabTest(TestRequest testRequest, CreateLabResult createLabResult) {
        ...
        try {
            ...
            if (createLabResult == null)
                throw new AppException("sorry no data found");
            ...
            testRequest.setLabResult(saveLabResult);
